...
public:
                      ...
                      const QModelIndex &index ) const
    {
        ...
        int ypad = 2;
        int halfheight = (mainRect.height() - 3*ypad)/3;
        ...
        QRect addressRect(mainRect.left() + xspace, mainRect.top()+ypad+halfheight+halfheight, mainRect.width() - xspace, halfheight);
