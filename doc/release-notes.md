...
- A proper fork of the Litecoin project on Github was made, incorporating all the changes that were in 1.1.3.0:
  - ShibeCoin specific branding
  - ShibeCoin specific block time, size, ...
...
- Following has been changed in comparison to the source of 1.1.3.0:
  ...
  - Changed references to "ShibeCoin Wiki" to ShibeCoin website
  - Changed references to shibecoin.org to shibecoin.com
  ...
  - Updated the addresses in Qt tests to a valid SHIBE address
  - Renamed litecoin.icns to shibecoin.icns according to config file
